 ...
 * 타입을 병합하는 방법은 다양하지만, 가장 흔한 방법이 유니언.
 * 
 * OR의 개념
 */
...
console.log(personOrCat);  //const personOrCat: Person
console.log(personOrCat2); //const personOrCat2: Cat
console.log(personOrCat3); //const personOrCat3: PersonOrCat
console.log(personOrCat4); //const personOrCat4: PersonOrCat